...
# data = pd.read_csv('https://raw.githubusercontent.com/yograjm/loan-defaulter-pred-may10/refs/heads/main/credit_risk_dataset.csv')
# print(data.head())
...
def append_data_to_db():
    ...
    # Read the CSV file
    csv_file_path = 'https://raw.githubusercontent.com/yograjm/loan-defaulter-pred-may10/refs/heads/main/credit_risk_dataset.csv'
    ...
    try:
        ...
        # Insert data into the loans data table
        #row_to_add = data.ilocif[[curr_rows], :]     # add row one-by-one
